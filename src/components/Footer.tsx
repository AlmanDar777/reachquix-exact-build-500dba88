      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t" style={{ borderColor: "rgba(255,255,255,0.1)" }}>
          <p className="font-body text-[12px] text-center md:text-left" style={{ color: "#64748B" }}>
            © 2026 Reachquix OÜ. All rights reserved. Registered in the Republic of Estonia, European Union
          </p>
          <div className="flex items-center gap-4">
            {socialIcons.map(({ icon: Icon, label, href, custom }) => (
              <a
                ...
                aria-label={label}
                className="min-w-[44px] min-h-[44px] flex items-center justify-center text-white transition-colors duration-200 cursor-pointer hover:text-primary"
              >
