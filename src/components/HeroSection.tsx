...
const HeroDashboard = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="font-body text-[12px] px-2 py-0.5 rounded-full bg-primary/10 text-primary font-medium">{t("hero.dashboardRunning")}</span>
          </div>
          {[
            { name: t("hero.row1Name"), subject: t("hero.row1Subject"), status: t("hero.row1Status"), statusColor: "bg-primary text-white" },
            { name: t("hero.row2Name"), subject: t("hero.row2Subject"), status: t("hero.row2Status"), statusColor: "bg-primary/10 text-primary" },
            { name: t("hero.row3Name"), subject: t("hero.row3Subject"), status: t("hero.row3Status"), statusColor: "bg-orange-100 text-orange-700" },
          ].map((row) => (
          ...
          <div className="mt-2">
            <div className="flex justify-between mb-1">
              <span className="font-body text-[11px] text-muted-foreground">{t("hero.deliveryRate")}</span>
      ...
      >
        <p className="font-body text-[12px] font-medium text-primary">{t("hero.replyDetected")}</p>
      ...
      >
        <p className="font-body text-[12px] font-medium text-secondary">{t("hero.campaignSent")}</p>
